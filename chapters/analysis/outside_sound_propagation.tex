...
\xfig{analysis/geo_of_crosswind.pdf_t}{The figure shows a geometrical interpolation of a wave moved by the wind}{fig:ana:geo_cross}{0.5}
...
To calculate the resulting wave direction unit vector, the following graphical illustration of the wave is used
...
\startexplain
\explain{d}{is the resulting wind gradient with a wave length of \SI{1}{\meter}}{\meter}
\explain{w}{is the resulting unit wave outer limit coverage direction}{\meter}
\explain{a}{is the outer limit coverage direction without wind}{\meter}
\explain{p}{is the orthogonal projection of the wind gradient intro $a$ }{\meter}
\explain{e}{is the projection $p$ added with the wind gradient $d$ }{\meter}
\stopexplain
...
\plot{plot/speaker_cov}{The graph shows the coverage area of two speaker with \SI{90}{\degree} angle}{plot:ana:spe_cov_area}{1}
