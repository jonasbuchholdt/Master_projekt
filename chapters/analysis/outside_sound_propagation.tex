...
It can be seen in \autoref{fig:ana:mea_two_one} that the general \gls{spl} is higher for microphone 1. Furthermore, both measurements show ground reflection in the frequency response. Besides the ground reflection, the general level is higher in the measurement measured by microphone 1. This difference indicates refraction upwards in the direction of microphone 2.  The resulting $L_{eq}$ \gls{spl} difference for all measurement is shown in \autoref{ta:ana:spl_dif}.
