Based on the knowledge founded in \autoref{ch:analysis} and the conclusion is drawn in \autoref{ch:analysis:summary}, a problem statement can be made. For the rest of this theses, the following is the focus.
