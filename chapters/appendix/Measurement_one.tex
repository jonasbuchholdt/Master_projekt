...
\plot{plot/measurement_one_one}{The graph shows the first transfer function measurement(IR_6)}{fig:ap:mea_one_one}
\plot{plot/measurement_one_two}{The graph shows the second transfer function measurement(IR_7)}{fig:ap:mea_one_two}
\plot{plot/measurement_one_three}{The graph shows the third transfer function measurement(IR_8)}{fig:ap:mea_one_thr}
