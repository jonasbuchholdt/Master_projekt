...
\dfig{IMG_0107}{The picture shows the line source array setup.}{IMG_0122}{The figure shows the wind direction.}{The figures shows the measurement set up for \autoref{ch:ap:measurement_one}.}{fig:ap:measuring_one_setup}{0.5}{0.5}
...
\plot{plot/measuring_sync_test_0_1}{The graph shows the test result for m1 at \SI{0}{\degree} rotation of the line source array. All blue weather curve is measured at the line source array tower, where all red weather curve is measured at the centre microphone position}{fig:ap:mea_sync_upw_0}
