...
\plot{plot/measuring_sync_test_0_1}{The graph shows the test result. All blue weather curve is measured at the line source array tower, where all red weather curve is measured at the center microphone position}{fig:ap:mea_sync_upw_0}
