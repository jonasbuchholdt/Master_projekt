\chapter{Frequency response of windscreen}\label{ap:wind_screen_freq_res}
...
The measurement shown in \autoref{fig:sec:pop:mic_ref_wit_ball_sma} shows the difference in frequency response of the speaker without the windscreen and with the windscreen configuration one. The \autoref{ap:freq:small_win} shows the measured set up. 
...
The measurement shown in \autoref{fig:sec:ap:mic_ref_wit_ball_lar} shows the difference in frequency response of the speaker without the windscreen and with the windscreen configuration two. The \autoref{ap:freq:large_win} shows the measured set up. 
...
The measurement shown in \autoref{fig:ap:pop:mic_ref_wit_ball_lar_roc_sin} shows the difference in frequency response of the speaker without the windscreen and with the windscreen configuration four. The \autoref{ap:freq:large_rock_sing_win} shows the measured set up. 
