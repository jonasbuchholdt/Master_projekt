...
\plot{plot/mic_ref_with_ball}{The graph shows }{fig:sec:pop:mic_ref_wit_ball}

\plot{plot/freq_resp_with_ball}{The graph shows the frequency }{fig:ap:freq_resp_with_ball}

\plot{plot/freq_resp_with_ball_small}{The graph shows the frequency }{fig:ap:freq_resp_with_ball_small}

\plot{plot/freq_resp_with_ball_large}{The graph shows the frequency }{fig:ap:freq_resp_with_ball_large}

\plot{plot/freq_resp_with_ball_rock}{The graph shows the frequency }{fig:ap:freq_resp_with_ball_rock}

\plot{plot/freq_resp_with_ball_rock_single}{The graph shows the frequency}{fig:ap:freq_resp_with_ball_rock_single}

\plot{plot/freq_resp_with_ball_large_rock_single}{The graph shows the frequency}{fig:ap:freq_resp_with_ball_large_rock_single}
