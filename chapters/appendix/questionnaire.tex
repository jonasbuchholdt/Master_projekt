...
\ask{How many audience attempt to a large concert you produces }{20000+}{Number}
\ask{What is the distances between the main stage to the first delay tower at medium concert}{30}{[\si{\meter]}}
\ask{How many audience attempt to a medium concert you produces }{10000}{Number}
\ask{Flying hight of top speaker }{14 - 16}{[\si{\meter}]}
\ask{Does the wind direction and speed influence on the distance decision}{Yes}{}
\ask{Do you want to know the end result }{No}{}
\ask{comment: He use to rotate the line array agents the wind if he know that the wind is crosswind and the wind will continue along the concert time. Moreover he would stop the concert if the wind speed is above \SI{10}{\meter\per\second}}{-}{}
\stopask
