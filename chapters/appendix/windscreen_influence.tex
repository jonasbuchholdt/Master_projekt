...
The designed windscreen gives a small boost in frequency below \Hz{1000} and above \Hz{4000} but the boost is only approximately \dB{2}. Moreover tilting of the designed windscreen gives plate reflection in the high frequency, but tilting at \SI{9}{\degree} only affect frequency above \SI{10}{\kilo\hertz}. Rotating the windscreen ether to the left or right gives a depth within \Hz{1000} to \Hz{4000}. While moving the foam wedge backwards the frequency response of the designed windscreen have only neglible differences. Removing the wedge gives high reflection from the designed windscreen.
