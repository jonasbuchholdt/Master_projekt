...
To be able to generate a controlled wind flow, the hall way in Fredrick Bajers vej 7B5, 9220 Aalborg is used. The following \autoref{ap:wind:flow_slow} shows a drawing of the area ans the position of the fan and windscreen.

\fig{wind_meas_pos}{The picture illustrate the area, where the wind flow is measured}{ap:wind:flow}{0.7}
...
\section*{Summary}
It is measured that all windscreen configuration lower the wind speed in the microphone position. The lowest attenuation of the wind is of the small foam wedge where the highest wind speed attenuation is attained by configuration five. Generally all windscreen yield turbulence wind direction, but the single rockwool bat configuration four seems to be the worst with respect to directional turbulence.
