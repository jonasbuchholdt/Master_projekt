...
To be able to generate a controlled wind flow, the hallway in Fredrick Bajers vej 7B5, 9220 Aalborg is used. The following \autoref{ap:wind:flow_slow_opt} shows a drawing of the area and the position of the fan and windscreen.
