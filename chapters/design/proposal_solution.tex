...
%\plot{plot/mic_ref_with_ball_small}{The graph shows }{fig:sec:pop:mic_ref_wit_ball_sma}
\plot{plot/mic_ref_with_ball_large}{The graph shows }{fig:sec:pop:mic_ref_wit_ball_lar}
\plot{plot/mic_ref_with_ball_rock}{The graph shows }{fig:sec:pop:mic_ref_wit_ball_roc}
\plot{plot/mic_ref_with_ball_rock_single}{The graph shows }{fig:sec:pop:mic_ref_wit_ball_roc_sin}
\plot{plot/mic_ref_with_ball_large_rock_single}{The graph shows }{fig:sec:pop:mic_ref_wit_ball_lar_roc_sin}
