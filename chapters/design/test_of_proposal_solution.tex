...
\subsection{General microphone positioning}\label{ts:gen_mic_pos}
...
\xfig{design/parallal_n3.pdf_t}{The figure shows the measurement setup}{fig:td:parallal_n3}{1} 

\xfig{design/parallal_n7.pdf_t}{The figure shows the measurement setup}{fig:td:parallal_n7}{1} 
...
\subsection{Hardware}
\fig{ard_shield.pdf}{The figure shows }{fig:td:ard_shield}{0.3}

\fig{ard_schematic.pdf}{The figure shows }{fig:td:ard_schematic}{0.5}
