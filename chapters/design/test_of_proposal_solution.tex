...
\subsection{Sensor and microprocessor}
The microprocessor for weather measurement is based on an Arduino UNO. The chose of an Arduino is made because code both the temperature and humidity sensor and the used anemometer is available on the internet.  
